...
4. **进完整主线** —— 长期备战默认走 [60 天完整主线](/interview/plans/60-day)
...
7. **临场回炉** —— 已约面或只剩压缩窗口时，走 [复习模块](/interview/review/00-overview)（9 速记 + 12 专题 + 3 / 7 / 14 天回炉）

**长期备战走 60 天，临场走复习模块。** 学习路线负责能力建设，复习模块负责临场调度，题库始终是唯一真源。

时间不够或需要加练时：

- **[14 天冲刺版](/interview/plans/14-day)**：约 2 周窗口的常规压缩（学习路线）
- **[7 天压缩版](/interview/plans/7-day)**：砍手写 / 系统设计深挖，保留 Vue3、工程化、主项目故事、AI + Java 叙事与 1 场模拟（学习路线）
- **[30 天强化版](/interview/plans/30-day)**：在 14 天骨架上加弱项回炉、更多手写与系统设计、多场模拟
- **[复习模块 · 临场回炉](/interview/review/00-overview)**：面试前 3 / 7 / 14 天专属日程，调度速记与专题，不替代 60 天主线
